...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        // Adiciona 7 estudantes a coleção
        ...
        System.out.println("Maior numero de letra: " + estudantes.stream().min(Comparator.comparingInt(String::length)));
        ...
        // Retorna true se nenhum dos elemtnos possuem a letra a minuscula no nome
        ...
        System.out.println(estudantes.stream()
                ...
                // .collect(Collectors.gourpingBy(estudante -> estudante.substring(estudante.indexOf("-") + 1 ))));
